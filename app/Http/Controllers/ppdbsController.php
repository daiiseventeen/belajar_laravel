...
class ppdbsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ppdb.index')->with('success', 'Data siswa berhasil ditambahkan!');
    }
    ...
    public function destroy($id)
    {
        $ppdb = ppdb::findOrFail($id);
        $ppdb->delete();
        return redirect()->route('ppdb.index')->with('success', 'Data siswa berhasil dihapus!');
    }
}
